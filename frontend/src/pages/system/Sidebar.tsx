...
const Sidebar = () => {
    ...
    return (
        ...
        <div className='flex flex-col gap-4'>
            ...
            <span >Mã thành viên: <small className='font-medium'>{userId?.slice(0, 6)}</small></span>
        </div>
        <div>
            <NavLink
            ...
            <span onClick={() => dispatch(logout())} className={notActiceStyle}><AiOutlineLogout />Thoát</span>
        </div>
    </div>
    );
};
